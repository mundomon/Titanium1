...
@interface ChooseAMonsterObject : KrollCoverageObject {
#else
@interface ChooseAMonsterObject : KrollObject {
#endif
@private
...
extern NSString * ChooseAMonster$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ChooseAMonsterObject *_chooseamonster;
    KrollObject* console;
	BOOL shutdown;
