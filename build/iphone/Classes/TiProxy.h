...
//Rare exceptions to indicate a bug in the _chooseamonster code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ChooseAMonster proxies.
 */
