...
//@interface ChooseAMonsterObject : NSObject
//@end

@interface ChooseAMonsterObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ChooseAMonsterObject class]])
		{
			for (NSString *key in [[(ChooseAMonsterObject*)o modules] allKeys])
			{
