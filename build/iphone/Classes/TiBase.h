...
// in simulator we redefine to format for ChooseAMonster Developer console
...
{\
	NSString * exceptionName = [@"org.chooseamonster." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.chooseamonster";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIChooseAMonsterNativeItemNone = -1, 
	UIChooseAMonsterNativeItemSpinner = -2,
	UIChooseAMonsterNativeItemProgressBar = -3,
	
	UIChooseAMonsterNativeItemSlider = -4,
	UIChooseAMonsterNativeItemSwitch = -5,
	UIChooseAMonsterNativeItemMultiButton = -6,
	UIChooseAMonsterNativeItemSegmented = -7,
	
	UIChooseAMonsterNativeItemTextView = -8,
	UIChooseAMonsterNativeItemTextField = -9,
	UIChooseAMonsterNativeItemSearchBar = -10,
	
	UIChooseAMonsterNativeItemPicker = -11,
	UIChooseAMonsterNativeItemDatePicker = -12,
	
	UIChooseAMonsterNativeItemInfoLight = -13,
	UIChooseAMonsterNativeItemInfoDark = -14,
	
	UIChooseAMonsterNativeItemDisclosure = -15,
	
	UIChooseAMonsterNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all ChooseAMonster instances of
